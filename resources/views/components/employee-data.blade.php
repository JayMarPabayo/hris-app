<div>
    ...
    <h3 class="text-base font-semibold text-cyan-700 mb-3">Family Background</h3>
    ...
    <div class="grid grid-cols-11 gap-x-1 gap-y-1 px-2 mb-5 items-start text-xs">
        ...
        <div class="col-span-4 row-span-2 text-slate-800 font-semibold">
            @foreach ($employee->children as $child)
                <p>
                    {{ $child->fullname }} <span class="font-medium text-xs text-slate-500">({{ $child->gender }})</span>
                </p>
            @endforeach
        </div>
        ...
        @if ($employee->spouse_businessaddress)
            <div class="col-start-7 col-span-2 text-slate-500 tracking-wider text-xs">
                Business Address
            </div>
            <div class="col-span-3 text-slate-800 font-semibold">
    ...
    @if ($employee->education->isNotEmpty())
        <div class="avoid-break">
            <h3 class="text-base font-semibold text-cyan-700 mb-3">Educational Background</h3>
    ...
    @if ($employee->workexperiences->isNotEmpty())
        <div class="avoid-break">
            <h3 class="text-base font-semibold text-cyan-700 mb-3">Work Experience</h3>
